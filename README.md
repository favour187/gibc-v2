...
3. Open `https://adaptive-learning-studio.onrender.com` (or whatever name Render assigns). Health: `/api/health`. Judges can log in with `demo@example.com / demo-password-123` (`SEED_DEMO_USER=true`).
