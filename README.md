# GIBC V2 — Adaptive Learning Studio

> An adaptive AI learning engine with personalized learning paths.

Scaffold is live. Competition-specific build (Phase 4) follows NextStep.

| | |
|---|---|
| **Event** | Global Innovation Build Challenge V2 (Devpost) |
| **Theme / Track** | Track 03: Open — General Technical Invention |
| **Build window** | Jul 11 – Sep 21, 2026 |
| **Deadline** | Sep 21, 2026 @ 11:45pm Taipei (15:45 UTC) |
| **Event verified** | ✅ Yes |
...
- `app/features/learning/` — **competition-specific module** (placeholder
...
Status: Scaffold is live. Competition-specific build (Phase 4) follows NextStep.
